    ...
    >
      ...
      <section className="bg-gradient-to-r from-[#7b2222] via-[#a83232] to-[#3b0a0a] text-white py-20 relative z-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Zdravi Obroci</h1>
          <p className="text-xl max-w-3xl mx-auto">
            Vaša putanja ka zdravijem životu počinje sa našim dnevno
            dostavljenim obrocima
          </p>
        </div>
      </section>
      ...
      <section className="py-16 relative z-20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-6 bg-gradient-to-r from-[#3b0a0a] via-[#a83232] to-[#8c282a] bg-clip-text text-transparent drop-shadow-lg">
              Vaša Svakodnevna Podrška za Zdravu Ishranu
            </h2>
            <p className="text-lg text-gray-600 max-w-4xl mx-auto">
              Svakog prepodneva na Vašu adresu, do vrata stana, dostavljamo Vam
              obroke za ceo dan. Naši stručni kuvari pripremaju svaki obrok sa
              pažljivo odabranim sastojcima, osiguravajući da svaki zalogaj bude
              ukusan i nutritivan.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-gray-50 p-8 rounded-lg text-center">
              ...
              <p className="text-gray-600">
                Sve obroke dostavljamo u činijama koje se mogu podgrejati u
                mikrotalasnoj. Nema pranja sudova - samo uživanje u ukusnoj
                hrani.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-lg text-center">
              ...
              <p className="text-gray-600">
                Uz escajg i činije koje možete poneti bilo gde sa sobom, nikada
                nije bilo lakše hraniti se zdravo.
              </p>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <p className="text-lg text-gray-700 mb-6">
                  Zato smo mi mislili na Vas i obezbedili Vam dostavu 5 obroka
                  dnevno, 7 dana nedeljno. Naši kuvari nemaju odmora ni
                  nedeljom, jer smo svesni da danas mnogo ljudi ne želi da svoj
                  slobodan dan provede spremajući hranu.
                </p>
                <p className="text-lg text-gray-700">
                  Svesni smo da današnji način života ostavlja sve manje vremena
                  za pripremu hrane. Koliko god bili odlučni da počnete zdravo
                  da se hranite, spremanje 5 zdravih obroka dnevno zahteva mnogo
                  vremena - od nabavke namirnica, pripreme hrane, do pranja
                  sudova.
                </p>
              </div>
              <div>
                <p className="text-lg text-gray-700 mb-6">
                  Danas kada se živi brže nego ikada, ovakav način pripreme
                  obroka često nije moguć i to je jedan od glavnih razloga zbog
                  kojeg ljudi ne uspevaju da istraju u ovoj odluci.
                </p>
                <p className="text-lg text-gray-700">
                  Naša misija je da Vam omogućimo da se hranite zdravo bez
                  žrtvovanja vremena i energije. Svaki obrok je pažljivo
                  planiran da obezbedi optimalnu ravnotežu proteina, ugljenih
                  hidrata i zdravih masti, prilagođen Vašim potrebama i
                  ciljevima.
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-5 gap-4">
              <div className="bg-white rounded-lg p-3 hover:shadow-xl shadow-lg transform hover:scale-105 transition-transform duration-200">
                <div className="flex items-center justify-center mx-auto ">
                  <Image
                    src="/images/dorucak.png"
                    alt="Doručak"
                    width={64}
                    height={64}
                    className="object-contain w-40 mb-2"
                  />
                </div>
                <h4 className="text-2xl font-semibold text-red-800 mb-2">
                  Doručak
                </h4>
                <p className="text-sm text-gray-600">
                  Energetski bogat početak dana
                </p>
              </div>
              <div className="bg-white rounded-lg p-3 hover:shadow-xl shadow-lg transform hover:scale-105 transition-transform duration-200">
                <div className=" flex items-center justify-center mx-auto">
                  <Image
                    src="/images/uzina1.png"
                    alt="Užina"
                    width={64}
                    height={64}
                    className="object-contain w-40 mb-2"
                ...
                <p className="text-sm text-gray-600">
                  Laki obrok za održavanje energije
                </p>
              </div>
              <div className="bg-white rounded-lg p-3 hover:shadow-xl shadow-lg transform hover:scale-105 transition-transform duration-200">
                <div className="flex items-center justify-center mx-auto">
                  <Image
                    src="/images/rucak.png"
                    alt="Ručak"
                    width={64}
                    height={64}
                    className="object-contain w-40 mb-2 "
                ...
                <p className="text-sm text-gray-600">
                  Glavni obrok sa kompletnim nutritivnim profilom
                </p>
              </div>
              <div className="bg-white rounded-lg p-3 hover:shadow-xl shadow-lg transform hover:scale-105 transition-transform duration-200">
                <div className="flex items-center justify-center mx-auto ">
                  <Image
                    src="/images/uzina2.png"
                    alt="Užina"
                    width={64}
                    height={64}
                    className="object-contain w-40 mb-2  "
                ...
                <p className="text-sm text-gray-600">
                  Popodnevni boost energije
                </p>
              </div>
              <div className="bg-white rounded-lg p-3 hover:shadow-xl shadow-lg transform hover:scale-105 transition-transform duration-200">
                <div className="flex items-center justify-center mx-auto">
                  <Image
                    src="/images/vecera.png"
                    alt="Večera"
                    width={64}
                    height={64}
                    className="object-contain w-40 mb-2"
        ...
        <section className="bg-gradient-to-r from-[#7b2222] via-[#a83232] to-[#3b0a0a] text-white py-16 mb-6 relative z-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a
              href="tel:0603044421"
              className="inline-block px-8 py-3 rounded-lg bg-white font-semibold shadow-lg border border-[#a83232] hover:bg-gray-100 transition-colors"
            >
